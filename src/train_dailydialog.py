...
from utils import DailyDialogueRobertaCometDataset, MaskedNLLLoss
...
if __name__ == '__main__':
    ...
    lf = open('logs/kamuh_dailydialog_logs.txt', 'a')
    ...
    rf = open('results/kamuh_dailydialog_results.txt', 'a')
