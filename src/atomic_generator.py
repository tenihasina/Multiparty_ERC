# -*- coding: utf-8 -*-
# THIS CODE IS FROM https://github.com/atcbosselut/comet-commonsense
# Bosselut, Antoine, et al. "Comet: Commonsense transformers for automatic knowledge graph construction." (2019).
