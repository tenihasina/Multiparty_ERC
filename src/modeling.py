#Rahman, Wasifur, et al. "Integrating multimodal information in large pretrained transformers." Proceedings of the conference. Association for Computational Linguistics. Meeting. Vol. 2020. NIH Public Access, 2020.
#source code : https://github.com/WasifurRahman/BERT_multimodal_transformer
